import { Component, ViewChild, OnInit } from '@angular/core'; // Add OnInit here
...
@Component({
  ...
  templateUrl: './mouvement-n.component.html',
  styleUrl: './mouvement-n.component.css'
})
export class MouvementNComponent implements OnInit {
